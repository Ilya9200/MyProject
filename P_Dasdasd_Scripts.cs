...
using Context = EleWise.ELMA.Model.Entities.ProcessContext.P_Dasdasd;

namespace EleWise.ELMA.Model.Scripts
{
    
    /// <summary>
    /// Модуль сценариев процесса "dasdasd"
    /// </summary>
    /// <example> 
    /// <![CDATA[
    /// >>>>>>>>>>>>>>>ВАЖНАЯ ИНФОРМАЦИЯ!!!<<<<<<<<<<<<<<<
    ...
    /// </example>
    public partial class P_Dasdasd_Scripts : EleWise.ELMA.Workflow.Scripts.ProcessScriptBase<Context>
    {
