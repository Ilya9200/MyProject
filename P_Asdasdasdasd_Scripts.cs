...
using Context = EleWise.ELMA.Model.Entities.ProcessContext.P_Asdasdasdasd;

namespace EleWise.ELMA.Model.Scripts
{
    
    /// <summary>
    /// Модуль сценариев процесса "asdasdasdasd"
    /// </summary>
    /// <example> 
    /// <![CDATA[
    /// >>>>>>>>>>>>>>>ВАЖНАЯ ИНФОРМАЦИЯ!!!<<<<<<<<<<<<<<<
    ...
    /// </example>
    public partial class P_Asdasdasdasd_Scripts : EleWise.ELMA.Workflow.Scripts.ProcessScriptBase<Context>
    {
