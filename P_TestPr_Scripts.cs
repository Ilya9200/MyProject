...
using Context = EleWise.ELMA.Model.Entities.ProcessContext.P_TestPr;

namespace EleWise.ELMA.Model.Scripts
{
	/// <summary>
	/// Модуль сценариев процесса "TestPr"
	/// </summary>
	/// <example> 
	/// <![CDATA[
	/// >>>>>>>>>>>>>>>ВАЖНАЯ ИНФОРМАЦИЯ!!!<<<<<<<<<<<<<<<
	...
	/// ]]>
	/// </example>
	public partial class P_TestPr_Scripts : EleWise.ELMA.Workflow.Scripts.ProcessScriptBase<Context>
	{
		/// <summary>
		/// TestPrCode
		/// </summary>
